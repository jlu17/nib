let projectTypeInfo = [
    {
        img: require('../img/projects/projectTypes/product.png'),
        alt: "Figma logo",
    ...
    {
        img: require('../img/projects/projectTypes/environment.png'),
        alt: "Cycle",
    ...
    {
        img: require('../img/projects/projectTypes/analysis.png'),
        alt: "Excel logo",
    ...
    {
        img: require('../img/projects/projectTypes/impact.png'),
        alt: "Money bags",
